...
int currentSong = 0; //enum in the future? for LCD
...
void loop(){
  ...
  switch (currentSong) {
    case 1:
      songPlayer(melody1, size1);
      break;
    case 2:
      songPlayer(melody2, size2);    
      break;
    case 3:
      songPlayer(melody3, size3);
      break;
    default: 
      ledState = LOW;
...
void songPlayer(int melody[], int size) {
